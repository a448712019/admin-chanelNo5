    ...
    submit = () => {
        this.props.form.validateFields((err, values) => {
            ...
            this.props.dispatch({
                ...
                payload: {
                    ...values,
                    logoImg: this.state.fileList.length > 0 ? this.state.fileList[0].url : '',
    ...
    render() {
        ...
        return (
            ...
            >
                    ...
                    {(!themeCurrent && !current) && <Form.Item {...formItemLayout} label='所属主题'>
                        {getFieldDecorator('sid', 
                        {
                            rules: [{ required: true, message: '请选择所属主题' }],
                        })(
                            <Select placeholder='所属主题'>
                                {this.props.theme.allTheme.map(item => <Select.Option key={item.id} value={item.id}>{item.daytitle}</Select.Option>)}
                    ...
                    <Form.Item {...formItemLayout} label='步骤类型'>
                        {getFieldDecorator('type', 
                        {
                            ...
                            <Select placeholder='步骤类型'>
                                ...
                                <Select.Option value='1'>观看产品视频</Select.Option>
                                <Select.Option value='1'>小测试</Select.Option>
                            </Select>
                        )}
                    </Form.Item>
