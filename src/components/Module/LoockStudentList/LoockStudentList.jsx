...
export default class LookStudentList extends React.Component{
    downStage1 = () => {
        this.props.dispatch({
            ...
            payload: {
                group_id: this.props.current.id
            }
    ...
    render() {
        ...
        const column = [
            ...
            },
            {
                ...
                key: 'sign',
                dataIndex: 'sign',
                sorter: (a, b) => (a.sign == 'true' ? 1 : 0) - (b.sign == 'true' ? 1 : 0),
                render: (value, item, index) => (
                    <Switch checked={value === 'true' ? true : false} onChange={this.onChange} />
                ),
        ...
        return (
            <Modal
                ...
                width={1200}
            >
                <Button type='primary' onClick={this.downStage1}>导出成绩</Button>
                <Divider />
                <Table 
                    columns={column}
