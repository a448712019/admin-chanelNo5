            ...
            },
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '1')} checked={item.wsign.w1 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '2')} checked={item.wsign.w2 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '3')} checked={item.wsign.w3 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '4')} checked={item.wsign.w4 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '5')} checked={item.wsign.w5 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '6')} checked={item.wsign.w6 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '7')} checked={item.wsign.w7 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '8')} checked={item.wsign.w8 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '9')} checked={item.wsign.w9 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '10')} checked={item.wsign.w10 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '11')} checked={item.wsign.w11 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                    {
                        ...
                        render: (_, item, index) => (
                            <div>
                                <Switch onChange={() => this.radioChange(item, index, '12')} checked={item.wsign.w12 == '1' ? true : false} />
                            </div>
                        ) 
                    },
                ...
                render: (_, item, index) => (
                    <div>
                        {cookie.load('currentUser').admin === 'admin' && 
                            <Popconfirm title="确定通过吗?" onConfirm={() => this.changeAllwo(item)}>
                                <Button className='m10' disabled={item.adopt == '1' ? true : false} type='primary'>
                                    {item.adopt == '1' ? '已通过': '通过'}
                                </Button>
                            </Popconfirm>
                        }
                        <Popconfirm title="确定删除吗?" onConfirm={() => this.confirm(item)}>
