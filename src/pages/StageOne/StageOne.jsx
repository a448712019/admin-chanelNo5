...
import { Table, Tag, Tabs, Popconfirm, Card, Radio, Input, Row, Col, Form, Button, Modal, notification, Select } from 'antd'
    ...
    render() {
            ...
            },
            {
                ...
                render: (_, item, index) => (
                    <div>
                        ...
                        <span className='link' onClick={() => this.openCodeModle(item)}>二维码</span>
                        ...
                        <span className='link' onClick={() => this.goResult(item)}>成绩查看</span>
                    </div>
                )
            }
        ]
        const userColumn = [
            ...
            },
            {
                ...
                key: 'date',
                dataIndex: 'date',
                sorter: (a, b) => (a.date ? new Date(a.date).getTime() : 0) - (a.date ? new Date(b.date).getTime() : 0),
            },
            {
                title: '工号',
                key: 'Worknumber',
            ...
            <PageHeaderWrapper>
                <Tabs activeKey={this.state.tabKey} onChange={this.callback}>
                    ...
                    <TabPane tab="用户添加" key="2">
                        <Card title='筛选'>
                            <Radio.Group defaultValue="" buttonStyle="solid" onChange={this.radioChange}>
                        ...
                        <Card title='搜索'>
                            <Row type='flex' align='middle'>
                                <Col align='middle' span={18}>
                                    <Col style={{lineHeight:'32px' }} span={3}>搜索内容：</Col>
                                    <Col span={14}>{tabKey == '2'  && <Input onBlur={this.inputChange} />}</Col>
                                    <Col span={5}>
                        ...
                        <Table 
                            ...
                            title={() => <Button type='primary' disabled={selectedRowKeys.length > 0 ? false : true } onClick={this.addGroup}>{currentUser ? '添加到分组' : '分组'}</Button>}
                        />
                    </TabPane>
                </Tabs>
                <Modal 
                ...
                >
                    <Row>
                        <Col>
                            <Col style={{textAlign: 'right', lineHeight: '32px'}} span={8}>点击生成签到二维码：</Col>
                            <Col span={6}><Button type='primary'  onClick={this.getSignCode}>生成签到二维码</Button></Col>
                        </Col>
                    </Row>
                    <div style={{height: '10px'}}></div>
                    <Row>
                        <Col>
                            <Col style={{textAlign: 'right', lineHeight: '32px'}} span={8}>二维码：</Col>
                            <Col span={6}>
                                <div style={{textAlign: 'center', width: '202px',height: '202px', border: '1px dashed rgb(170, 170, 170)'}}>
                                    ...
                                    <span style={{lineHeight: '202px'}}>加载失败请重新生成</span> */}
                                    {
                                        ...
                                        ?
                                        <img style={{width: '200px'}} src={this.props.stageManage.signCode}/>
                                        :
                                        <span style={{lineHeight: '202px'}}>加载失败请重新生成</span>
                    ...
                    <Row>
                        <Col>
                            <Col style={{textAlign: 'right', lineHeight: '32px'}} span={8}>点击生成考试二维码：</Col>
                            <Col span={6}><Button type='primary' onClick={this.getTestCode}>生成考试二维码</Button></Col>
                        </Col>
                    </Row>
                    <div style={{height: '10px'}}></div>
                    <Row>
                            ...
                            <Col span={6}>
                                <div style={{textAlign: 'center', width: '202px',height: '202px', border: '1px dashed rgb(170, 170, 170)'}}>
                                    
                                    {
                                        ...
                                        ?
                                        <img style={{width: '200px'}} src={this.props.stageManage.testCode}/>
                                        :
                                        <span style={{lineHeight: '202px'}}>加载失败请重新生成</span>
                                    }
                                </div>
