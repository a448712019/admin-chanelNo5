...
//教师模块
export async function getTeacherList(params) { //教师列表
  return request('entry=sys&c=adminList&a=admin&do=adminList', {
    method: 'POST',
    body: params,
  })
}
export async function delTeacher(params) { //删除教师
  console.log(params)
...
export async function tyepList(params) { //角色类型
  console.log(params)
...
export async function teacherDetail(params) { //教师详情
  console.log(params)
...
export async function editPassword(params) { //编辑密码
  console.log(params)
...
export async function confirm(params) { //确认修改密码
  console.log(params)
...
export async function confirmEditUser(params) { //确认修改角色分配
  console.log(params)
...
//离职模块
export async function getLeaveList(params) { //确认修改角色分配
  return request('entry=sys&c=user&a=userManagement&do=deleteList', {
    method: 'POST',
    body: params,
  })
}
export async function delLeave(params) { //确认修改角色分配
...
//每日统计
export async function getYear(params) { //获取年份
  return request('entry=sys&c=group&a=value&do=year', {
    method: 'POST',
    body: params,
  })
}
export async function getTime(params) { //获取期数
  return request('entry=sys&c=group&a=value&do=batch', {
    method: 'POST',
    body: params,
  })
}
export async function getCity(params) { //获取城市
  return request('entry=sys&c=group&a=value&do=county', {
    method: 'POST',
    body: params,
  })
}
export async function getDayData(params) { //获取每日数据
...
export async function exportDayData(params) { //获取每日数据
  console.log(params)
  return fileDown('entry=sys&c=group&a=day_screen&do=day_screen', params)
}

//阶段测试统计
export async function getGroup(params) { //获取分组数据
...
export async function errorTop5List(params) { //获取错题排行榜
...
export async function sortList(params) { //获取排行榜数据
...
export async function downError(params) { //下载单题错误记录
  console.log(params)
  return fileDown('entry=sys&c=group&a=record_export&do=subject_export', params)
}
export async function errorSelData(params) { //选择次数
...
export async function questionDetail(params) { //题目选择项
...
//用户管理
export async function userList(params) { //用户列表
...
export async function userDetail(params) { //学员详情
...
export async function userUpdate(params) { //学员更新
...
export async function leaveUser(params) { //学员离职
...
//培训阶段管理
//阶段1
export async function groupList(params) { //分组列表
...
export async function groupStudentList(params) { //分组学员列表
...
export async function delGroupStudent(params) { //删除分组学员
...
export async function allUserList(params) { //未分组学员列表
...
export async function addUserToGroup(params) { //添加学员到分组
...
export async function updateRenameOrStatus(params) { //更新组名 状态
...
export async function deleteGroup(params) { //删除组
...
export async function getSignParams(params) { //获取签到二维码参数
...
export async function getTestParams(params) { //获取考试二维码参数
...
export async function getStageList(params) { //获取阶段列表
...
export async function getCode(params) { //获取二维码
...
export async function getSignCode(params) { //获取签到二维码
...
export async function getTestCode(params) { //获取考试二维码
...
export async function downStage1GroupStuden(params) { //导出分组学员成绩
  console.log(params)
  return fileDown('entry=sys&c=group&a=export&do=export_stage1', params)
}
//过渡期
export async function getTransitionList(params) { //获取过渡期分组列表
...
export async function getTransitionGroupList(params) { //获取过渡期分组学员
...
export async function changeWeekStatus(params) { //更改学员每周状态
...
export async function changeAllow(params) { //更改学员每周状态
...
export async function changeAllows(params) { //批量通过
...
export async function delTransition(params) { //批量通过
...
export async function noTransitionGroup(params) { //过渡期学员列表
...
export async function addTransitionGroup(params) { //分组
...
export async function addTransitionStatus(params) { //分组
  return request('entry=sys&c=teacher&a=student&do=status', {
    method: 'POST',
    body: params,
    isForm: true
...
export async function Theme(params) { //stageList
  return request('entry=sys&c=stage&a=stage&do=list', {
    method: 'POST',
    body: params,
    isForm: true
...
export async function editStage(params) { //编辑阶段
...
export async function delTransitionGroup(params) { //分组
...
export async function saveStage(params) { //保存阶段
...
export async function delStage(params) { //删除阶段
...
export async function downTransition(params) { //导出过渡期组
  console.log(params)
  return fileDown('entry=sys&c=group&a=export&do=export_stage2', params)
}

//主题内容更改
export async function themeList(params) { //主题列表
...
export async function getThemeStageList(params) { //主题 阶段列表
...
export async function getThemeDetail(params) { //主题 详情
...
export async function uploadImage(params) { //上传图片
...
export async function updateTheme(params) { //更新主题
...
export async function delTheme(params) { //del主题
...
export async function allTheme(params) { //allTheme
...
export async function saveStep(params) { //编辑或新增步骤
...
export async function stepList(params) { //编辑或新增步骤
...
export async function stepDetail(params) { //步骤详情
...
export async function delStep(params) { //步骤删除
...
//typeone
export async function tyepOneList(params) { //列表
...
export async function saveTypeOne(params) { //添加typeone
...
export async function typeOneDetail(params) { //typeone详情
...
export async function delTypeOne(params) { //typeone删除
...
export async function delTypeTwo(params) { //typeone删除
...
export async function delTypeThree(params) { //typethree删除
...
export async function typeTwoList(params) { //typeoTwo列表
...
export async function typeFourList(params) { //typeofour列表
...
export async function typeThreeList(params) { //typeothree列表
...
export async function typeTwoSave(params) { //typeoTwo更新或新增
...
export async function typeThreeSave(params) { //typeoThree更新或新增
...
export async function addFour(params) { //typeofour新增
...
export async function updateFour(params) { //typeofour更新
...
export async function fourDetail(params) { //typeofour详情
...
export async function typeTwoDetail(params) { //typetwo详情
...
export async function typeThreeDetail(params) { //typethree详情
...
//权限
export async function authorList(params) { //权限list
...
export async function authorDetail(params) { //权限detail
...
export async function addAuthor(params) { //add权限
...
export async function updateAuthor(params) { //update权限
...
export async function delAuthor(params) { //删除
